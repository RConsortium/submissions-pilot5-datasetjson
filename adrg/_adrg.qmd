...
# of '01' is used. If both the month and day are missing no imputation is performed 
# as these dates clearly indicate a start prior to the beginning of treatment. There 
# are no events with completely missing start dates.
...
# A tibble: 5 × 11
  USUBJID     QSSEQ PARAMCD  AVISIT   VISIT      AVAL DTYPE  ANL01FL ADT          ADY
  <chr>       <dbl> <chr>    <chr>    <chr>     <dbl> <chr>  <chr>   <date>     <dbl>
1 01-701-1294  5015 ACTOT    Baseline BASELINE      9 ""     "Y"     2013-03-24     1
2 01-701-1294  5030 ACTOT    Week 8   WEEK 8       14 ""     "Y"     2013-05-22    60
3 01-701-1294  5045 ACTOT    Week 8   WEEK 12      14 "LOCF" ""      2013-06-14    83
4 01-701-1294  5045 ACTOT    Week 16  WEEK 12      14 "LOCF" "Y"     2013-06-14    83
5 01-701-1294  5060 ACTOT   Week 24   RETRIEVAL     9 ""     "Y"     2013-10-08   199
```
...
1 01-701-1294  5015 ACTOT    Baseline BASELINE      9 ""     "Y"     2013-03-24     1
2 01-701-1294  5030 ACTOT    Week 8   WEEK 8       14 ""     "Y"     2013-05-22    60
3 01-701-1294  5045 ACTOT    Week 8   WEEK 12       6 ""     ""      2013-06-14    83
4 01-701-1294  5030 ACTOT    Week 16  WEEK 8       14 "LOCF" "Y"     2013-05-22    60
5 01-701-1294  5060 ACTOT    Week 24  RETRIEVAL     9 ""     "Y"     2013-10-08   199
```
...
```r
> diffdf(adtte, qc_adtte, 
+     keys = c("STUDYID", "USUBJID", "PARAMCD", "SRCDOM", "STARTDT"))
Differences found between the objects!
