...
???Should this come before Step 1???
...
??? should we say something about restarting R and getting project is synced message ???
...
2. Restart R Session - this will ppulate the list of paths in your Global Environment.  Double check that this object has been created.
...
Cross-check if anything has changed form Pilot 3 to Pilot 5 for QC Findings
