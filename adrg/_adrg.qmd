...
not fit for purpose. See Appendix X for more details on differences between 1.1 and 1.0. Both
...
Cross-check if anything has changed from Pilot 3 to Pilot 5 for QC Findings
https://github.com/RConsortium/submissions-pilot5-datasetjson/wiki/QC-Findings
