...
Different open-source packages were used to create the submission package. Evaluating FDA’s acceptance of system/software validation evidence is not in the scope of this pilot.
