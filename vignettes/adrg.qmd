...
library(readr)   # or use base R: read.csv()
library(dplyr)   # optional, for data manipulation
library(knitr)   # for nicer table display
library(kableExtra)

# Read the CSV file
tab_var_label <- read_csv(here::here("vignettes/llm-adrg-out/adam_var_label_table.csv"))
...
tab_var_filter <- read_csv(here::here("vignettes/llm-adrg-out/tlg_var_filter_table.csv"))

# Display the table
kable(tab_var_filter,  format = "latex", booktabs = TRUE) %>%
...
pkg_tab <- read_csv(here::here("vignettes/llm-adrg-out/pkg_descriptions.csv"))

# Display the table
kable(pkg_tab,  format = "latex", booktabs = TRUE, longtable = TRUE) %>%
